...
def missing_galaxies(pth, num_gals):
    ...
    Arguments:
    pth: path to input fitsfiles
         e.g. pth = 'galfit_outputs_f8/residual/f8*.fits'

    num_gals: total number of galaxies, e.g. 302
...
if __name__ == "__main__":
    ...
    # log1 = 'fit_expdisk_f6.log'
    # main(pth1, log1)
    # print(('band: f606w'))
    # f814w band
    pth2 = 'galfit_outputs_f8/residual/f8*.fits'
    log2 = 'fit_expdisk_f8.log'
    main(pth2, log2)
    print(('band: f814w'))
